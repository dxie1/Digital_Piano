...
// ============Di and Jesus: We may use this for another purpose if time permits==============
...
// ***************** Timer0A_Init ****************
// Activate Timer0A interrupts 
// Inputs:  period in usec
// Outputs: none
void Timer0A_Init(unsigned short period){long sr; volatile unsigned long delay;
  sr = StartCritical(); 
  SYSCTL_RCGC1_R |= SYSCTL_RCGC1_TIMER0; // 0) activate timer0
  delay = SYSCTL_RCGC1_R;						// delay
...
void Timer0A_Handler(void){ static unsigned char k=0;
